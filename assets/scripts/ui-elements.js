...
function initUIElements() {
    ...
    try {
        ...
        // Connector geometry lives in node-panels.js, which owns #nodeWires.
        //
        // It used to be built here and again in the resize path below - two copies of the
        // same geometry, so a connector could never follow a panel that moved, and the
        // bottom one was drawn as a quadratic Bezier rather than right angles. A single
        // owner outside this file also survives the rebuild that clears this SVG.
        ...
        const updatePositions = debounce(() => {
            try {
                ...
                // See note above: connectors are owned by node-panels.js.
